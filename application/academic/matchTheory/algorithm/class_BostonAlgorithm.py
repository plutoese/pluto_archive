            ...
            for woman in self._women:
                ...
                if len(woman._be_prosoed_by) > 0:
                    ...
                    if accepted is not None:
                        woman._accept.extend([self._men_mapping[acc] for acc in accepted])
...
if __name__ == '__main__':
    ...
    men = [Male('i1', ['b', 'a', 'c']),
           Male('i2', ['b', 'c', 'a']),
           Male('i3', ['a', 'b', 'c'])]
    women = [Female('a', ['i2', 'i1', 'i3']),
             Female('b', ['i3', 'i2', 'i1']),
             Female('c', ['i2', 'i3', 'i1'], 1)]

    matcher = StableMatcher(men=men, women=women)
    matcher.match(echo=True)
    print(matcher)
