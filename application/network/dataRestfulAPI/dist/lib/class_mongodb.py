...
if __name__ == '__main__':
    ...
    mongo = MongoDB(conn_str='mongodb://cfzhang:z1Yh29@dds-bp162bb74b8184e41658-pub.mongodb.rds.aliyuncs.com:3717')
    mdb = MonDatabase(mongodb=mongo, database_name='microdata')
    print(mongo.database_names)
    mdb.create_collection('share_holder')
