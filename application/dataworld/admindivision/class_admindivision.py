...
import re
from application.dataworld.admindivision.class_admindivisiondatabase import AdminDivisionDatabase
...
if __name__ == '__main__':
    ...
    print(adivision.get_prefecture('湖北','荆州市'))
    print(adivision['南京大学'])
